...
class Ds18b20Logger:
    ...
    def __initialize_sensors(self):
        ...
        for s_id, s_name in DS18B20Config.DEV_ID_NAME.items():
            ...
            self.sensors.append(W1Ds18b20(sensor_name=s_name, sensor_id=s_id))
    ...
    def __write_temperatures(self):
        ...
        while True:
            w1_data = DevData(CsvConfig.DS18B20_LOG_DIR_AND_FILE_PREFIX, JsonRequestType.DS18B20)

            for sensor in self.sensors:
                data = sensor.read_data_json()
                if data is None:
                    app_logging.debug(
                        "Data is probably obsolete or incomplete. Obsolete counter: %d",
